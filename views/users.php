                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?=$user->username;?>">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                ...
                                <a href="../index.php" class="mt-1 d-block fs-sm fw-400 text-dark">
        ...
        <footer class="page-footer" role="contentinfo">
            ...
            <div>
                <ul class="list-table m-0">
                    <li><a href="../index.php" class="text-secondary fw-700">Home</a></li>
                    <li class="pl-3"><a href="../index.php" class="text-secondary fw-700">About</a></li>
                </ul>
            </div>
        </footer>
