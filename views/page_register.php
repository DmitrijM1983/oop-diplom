                                ...
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <input name="username" type="text" id="usernameverify" class="form-control" placeholder="">
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="userpassword">Пароль еще раз<br></label>
                                            <input name="password2" type="password" id="userpassword" class="form-control" placeholder="">
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
